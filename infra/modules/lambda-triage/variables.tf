# ---------------------------------------------------------------------------
# Lambda Triage Module — Variables
# ---------------------------------------------------------------------------
...
variable "lambda_remediate_arn" {
  description = "ARN of the remediation Lambda to invoke for auto-fix"
  type        = string
}

variable "lambda_explainer_arn" {
  description = "ARN of the explainer Lambda to invoke for AI analysis"
  type        = string
}
